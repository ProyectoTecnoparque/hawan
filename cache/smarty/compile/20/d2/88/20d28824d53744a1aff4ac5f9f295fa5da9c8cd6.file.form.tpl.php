<?php /* Smarty version Smarty-3.1.19, created on 2021-08-09 15:53:34
         compiled from "C:\xampp\htdocs\hotelcom\admin96382jajf\themes\default\template\controllers\access\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1019442405611195ceb61435-54933298%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '20d28824d53744a1aff4ac5f9f295fa5da9c8cd6' => 
    array (
      0 => 'C:\\xampp\\htdocs\\hotelcom\\admin96382jajf\\themes\\default\\template\\controllers\\access\\helpers\\form\\form.tpl',
      1 => 1617197312,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1019442405611195ceb61435-54933298',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_611195cec593d4_53674006',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_611195cec593d4_53674006')) {function content_611195cec593d4_53674006($_smarty_tpl) {?>
			...
			<?php if ($_smarty_tpl->tpl_vars['profile']->value['id_profile']!=$_smarty_tpl->tpl_vars['admin_profile']->value) {?>
				<div class="col-lg-6">
					<?php if (isset($_smarty_tpl->tpl_vars['hotels']->value)&&$_smarty_tpl->tpl_vars['hotels']->value) {?>
						<div class="panel">
							<h3><?php echo smartyTranslate(array('s'=>'Hotel Permissions'),$_smarty_tpl);?>
</h3>
...
"<?php } else { ?> disabled="disabled"<?php }?>/>
								...
								<tbody>
									...
									<?php } else { ?>
										<?php  $_smarty_tpl->tpl_vars['hotelInfo'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['hotelInfo']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['hotels']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['hotelInfo']->key => $_smarty_tpl->tpl_vars['hotelInfo']->value) {
$_smarty_tpl->tpl_vars['hotelInfo']->_loop = true;
?>
...
||all" class="changeHotelAccess ajax-htl-all"<?php } else { ?> class="all" disabled="disabled"<?php }?><?php if (isset($_smarty_tpl->tpl_vars['hotelAccess']->value[$_smarty_tpl->tpl_vars['profile']->value['id_profile']][$_smarty_tpl->tpl_vars['hotelInfo']->value['id']]['access'])&&$_smarty_tpl->tpl_vars['hotelAccess']->value[$_smarty_tpl->tpl_vars['profile']->value['id_profile']][$_smarty_tpl->tpl_vars['hotelInfo']->value['id']]['access']) {?> checked="checked"<?php }?>/>
												</td>
											</tr>
										<?php } ?>
									<?php }?>
