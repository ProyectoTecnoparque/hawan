                            ...
                            <div class="container">
                                <div class="row header-rmsearch-inner-wrapper ">
                                    ...
                                    <?php } else { ?>
                                        col-sm-6 col-lg-3
                                    <?php } ?>">
                                                <input type="text" class="form-control header-rmsearch-input" id="hotel_location" name="hotel_location" autocomplete="off" placeholder="<?php echo smartyTranslate(array('s' => 'Ubicación de Experiencia', 'mod' => 'wkroomsearchblock'), $_smarty_tpl); ?>">
                                                <div class="dropdown">
