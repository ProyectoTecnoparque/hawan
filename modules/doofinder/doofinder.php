...
class Doofinder extends Module
{
    ...
    protected function createInstallationID($shopHashes, $defaultHash)
    {
        ...
        file_put_contents(dirname(__FILE__).'/doofinder.log', "\xA". $shRequest, FILE_APPEND);
        file_put_contents(dirname(__FILE__).'/doofinder.log', "\xA". $shResponse->response, FILE_APPEND);
        file_put_contents(dirname(__FILE__).'/doofinder.log', "\xA". $installationID, FILE_APPEND);
